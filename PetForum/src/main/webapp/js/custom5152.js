                ...
                $('.responsive-nav').on('change', function() {
        	        ...
        	        switch(action){
			            case 'list':
			                       ...
			                       break;
			            case 'fb':
//			                        var a = $("<a href='http://123.206.226.82:8080/PetForum/sendActical.html' target='_blank'>Apple</a>").get(0);
//									var e = document.createEvent('MouseEvents');
//									e.initEvent( 'click', true, true );
//									a.dispatchEvent(e);
//			            window.open("http://123.206.226.82:8080/PetForum/sendActical.html",'newwindow','height=100,width=100,top=100,left=100');
			            location.href = "http://123.206.226.82:8080/PetForum/sendActical.html";
//			                        window.open("http://123.206.226.82:8080/PetForum/sendActical.html");
			                        break;
			            case 'about':
			                        break;
                        case 'join':
