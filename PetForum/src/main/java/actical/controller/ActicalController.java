...
import actical.model.TestAppModel;
import actical.model.TestChildrenModel;
...
public class ActicalController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/getMyKeepAct/paging/{pageIndex}/{pageSize}",method = RequestMethod.POST)
	@ResponseBody
	public Map<String,Object>getMyKeepAct(@RequestParam("userId") String userId,@PathVariable int pageIndex,@PathVariable int pageSize,
			HttpServletRequest request,HttpServletResponse response){
		// 取得request中的数据对象
		return acticalService.getMyKeepAct(pageIndex,pageSize,userId);
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/findHasById/{id}",method = RequestMethod.POST)
	@ResponseBody
	public Map<String,Object>findHasById(@PathVariable int id,
			HttpServletRequest request,HttpServletResponse response){
		// 取得request中的数据对象
		return acticalService.findHasById(id);
	}
	...
	public Map<String,Object>delAct(@PathVariable int invitation_id, 
			HttpServletRequest request,HttpServletResponse response){
		return acticalService.delAct(invitation_id,request.getHeader("token"));
	}
	...
	public Map<String,Object>delReplay(@PathVariable int replayId, 
			HttpServletRequest request,HttpServletResponse response){
		return acticalService.delReplay(replayId,request.getHeader("token"));
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/getInfoNotRead",method = RequestMethod.POST)
	@ResponseBody
	public Map<String,Object>getInfoNotRead(HttpServletRequest request,HttpServletResponse response){
		return acticalService.getInfoNotRead(request.getHeader("token"));
	}
	/**
	 * 跟新消息为已读
	 * @param id
	 ...
	 * @return
	 */
	@RequestMapping(value = "/inKeep",method = RequestMethod.POST)
	@ResponseBody
	public Map<String,Object>inKeep(@RequestBody KeepModel keepModel,HttpServletRequest request,HttpServletResponse response){
		return acticalService.inKeep(keepModel,request.getHeader("token"));
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/isKeep",method = RequestMethod.POST)
	@ResponseBody
	public Map<String,Object>isKeep(@RequestBody KeepModel keepModel,HttpServletRequest request,HttpServletResponse response){
		return acticalService.isKeep(keepModel,request.getHeader("token"));
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/cancleKeep",method = RequestMethod.POST)
	@ResponseBody
	public Map<String,Object>cancleKeep(@RequestBody KeepModel keepModel,HttpServletRequest request,HttpServletResponse response){
		return acticalService.cancleKeep(keepModel,request.getHeader("token"));
	}
	/**
	 * 
	 * @Title: uploadFile
	 ...
	 * @return
	 */
	@RequestMapping(value = "/testApp",method = RequestMethod.POST)
	@ResponseBody
	public void testApp(@RequestBody List<TestAppModel> testAppModel,HttpServletRequest request,HttpServletResponse response){
		for(int i=0;i<testAppModel.size();i++){
			TestChildrenModel [] testChildrenModelArr = testAppModel.get(i).getChildrenArr();
			for(int j=0;j<testChildrenModelArr.length;j++){
				System.out.println(testChildrenModelArr[j].getCompCode());
			}
		}
	}
	/**
